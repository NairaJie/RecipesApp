...
class MainActivity : AppCompatActivity() {
    ...
    private fun showToast(recipe : Recipe){
        Toast.makeText(this, "Makanan favorit kamu ${recipe.name}",Toast.LENGTH_SHORT).show()
    }
    ...
    private fun getRecipe(): ArrayList <Recipe> {
        ...
        val dataIngeredients = resources.getStringArray(R.array.ingredients)
